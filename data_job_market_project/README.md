...
This project focuses into the data job market. Focusing on data analyst roles, this project explores top-paying jobs, in-demand skills, and where high demand meets high salary in the field of data analytics.

Driven by a quest to navigate towards the data analyst job market more effectively and efficiently, this project was intended to pinpoint top-paid and in-demand skills, streamlining job seekers to find the most optimal jobs.

Check out my SQL queries here: [queries folder](queries)
...
View the full query here: [1_top_paying_jobs.sql](queries/1_top_paying_jobs.sql)

### Results

![Top 10 Highest Paying Data Analyst Jobs](assets/01_top_paying_jobs.png)
...
- **Wide Salary Range**: Top 10 paying data analyst roles span from $184,000 to $650,000, indicating significant salary potential in the field. However, the company, Mantys, seems to be an outlier — without it included, the remaining jobs average out to around $220K.
- **No Tech Giants**: While Meta is certainly a recognizable name within the top 10, the majority of the top paying roles are from companies people haven't heard much from, including SmartAsset, Mantys, and Inclusively. This suggests that some smaller companies are willing to prioritize paying more for data talent than household names.
...
View the full query here: [2_top_skills.sql](queries/2_top_skills.sql)

### Results

![Top Skills](assets/02_top_skills.png)
...
View the full query here: [3_in_demand_skills.sql](queries/3_in_demand_skills.sql)
...
- SQL, Excel, Python, Tableau, and Power BI cover the core toolkit that the market demands. Mastering these five gives great coverage across the majority of data analyst job postings.
...
View the full query here: [4_top_paying_skills.sql](queries/4_top_paying_skills.sql)

### Results

![Top 25 Highest Paying Skills for Data Analysts](assets/04_top_paying_skills.png)
...
- Six AI/ML related skills appear in the top 25, including MXNet, Keras, PyTorch, Hugging Face, TensorFlow, and DataRobot, all averaging in the range of $120K-$155K. AI/ML adjacent skills command a significant salary premium for data analysts.
- None of the top 5 most in-demand skills from the previous chart — SQL, Excel, Python, Tableau, Power BI — appear in this top 25. The skills the market demands most are not the same ones that pay the most. The sweet spot for salary growth is pairing foundational skills with niche, specialized tools as aspiring data analysts adapt throughout their careers.

## 5. Most Optimal Skills to Learn

Balancing out both the top paying skills and the most in-demand skills, this query — incorporating a combination of CTEs — explores the most optimal skills for aspiring Data Analysts to master to succeed in their data analytics career.
...
View the full query here: [5_most_optimal_skills.sql](queries/5_most_optimal_skills.sql)

### Results

![Optimal Skills for Data Analysts](assets/05_optimal_skills.png)
...
- Kafka pays the most at $130,000 but only appears in 40 job postings. PyTorch and Perl also pay well but have very low demand. These are specialist skills that pay a premium precisely because few people have them, but the job opportunities are limited.

# What I Learned

Throughout this project, I applied a lot to my SQL capabilities:
...
5. **Optimal Skills for Job Market Value**: Snowflake leads in the combination of demand and salary, positioning cloud/big-data skills as some of the most optimal for data analysts to learn to maximize their market value.
